...
const SideBar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-auto scroll-smooth text-white ${selectedUser ? "max-md:hidden" : ''} `} >
      <div className="pb-5">
        <div className="flex justify-between items-center">
          <img src={assets.logo} alt="logo" className="max-wd-40" />
  ...
  hidden group-hover:block"
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5" >
            ...
            <input onChange={(e)=> setInput(e.target.value)} value={input} type="text" className="bg-transparent border-none outline-none text-white text-xs placeholder-[#c8c8c] flex-1" placeholder="Search User.." />
        </div>
      </div>
